...
#### Johnny-Five es un protocolo basado en Firmata de código abierto,Framework de Internet de las Cosas y programación robótica, desarrollado en [Bocoup] (http://bocoup.com). Los programas de Johnny-Five pueden ser escritos para Arduino (todos los modelos), Electric Imp, Beagle Bone, Intel Galileo vs Edison, Linino Uno, Pinocho, pcDuino3, Raspberry Pi, Spark Core, TI Launchpad y mucho más!
